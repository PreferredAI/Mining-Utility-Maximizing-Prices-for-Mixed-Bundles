...
parser.add_argument("-cl", "--cluster", type=int, help="Clusters", default = 4)
...
configurations = {
    'Pruning_Enabled': {'refinement': True, 'prune': True, 'bmkc': True, 'comp_ind': False, 'lattice': True},
    'Pruning_Disabled': {'refinement': True, 'prune': False, 'bmkc': True, 'comp_ind': False, 'lattice': True}
}

results = {key: {'refined': [], 'unrefined': [], 'time': []} for key in configurations}


print("Experiment on Pruning Compared with No Pruning")
