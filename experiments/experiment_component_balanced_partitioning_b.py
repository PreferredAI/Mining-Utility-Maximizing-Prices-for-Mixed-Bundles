# Comparing balanced partitioning methods B = 100
...
parser.add_argument("-cl", "--cluster", type=int, help="Clusters", default = 20)
...
print("Experiment on Balanced Partitioning B = 100")
components = comp
