...
for clusters in clusters_list:
    ...
    configurations = {
        'Reverse_Competitive_Independence': {'refinement': True, 'prune': True, 'bmkc': True, 'comp_ind': True, 'lattice': True, 'random': False},
        'Competitive_Independence': {'refinement': True, 'prune': True, 'bmkc': True, 'comp_ind': False, 'lattice': True, 'random': False},
        'Random': {'refinement': True, 'prune': True, 'bmkc': True, 'comp_ind': False, 'lattice': True, 'random': True}
    }
